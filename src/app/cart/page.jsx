        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          ...
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button
                onClick={() => router.push("/")}
                className="bg-blue-600 cursor-pointer hover:bg-blue-700 text-white px-6 py-2.5 rounded-full font-medium transition-colors"
              >
                Start shopping
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-3">
                          <button
                            ...
                            className="p-1 border cursor-pointer border-gray-300 rounded hover:bg-gray-100 transition-colors"
                          >
                      ...
                      <div className="flex flex-col items-end justify-between">
                        <button
                          ...
                          className="p-2 cursor-pointer text-gray-500 hover:text-red-600 hover:bg-red-50 rounded transition-colors"
                        >
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">
                    Sign up for 15% off on your next order. Well keep your
                    details safe. See our privacy policy.
                  </p>
                </div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-6 bg-gray-50 p-6 rounded-lg">
                  ...
                  <button className="w-full cursor-pointer bg-black text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors mb-3">
                    Checkout
                  </button>
                  ...
                  <button className="w-full border cursor-pointer border-gray-300 text-gray-700 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors">
                    Apply
                  </button>
                </div>
              </div>
